...
from zmb_hcs.hcs.faim_ipa.imagexpressZMB import StackAcquisition, SinglePlaneAcquisition_as3D
from zmb_hcs.hcs.fractal import roi_tables
...
def convert_MD_plane_as3D(
    ...
    print("Parsing files...")
    plate_acquisition = SinglePlaneAcquisition_as3D(
        acquisition_dir=input_path,
        alignment=alignment,
        query=query,
    )
